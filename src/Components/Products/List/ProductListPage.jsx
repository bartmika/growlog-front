                ...
                <div className="w3-hide-large w3-hide-medium">
                    ...
                    <div className="w3-row">
                        <div className="w3-col s8 w3-container">
                            <span className="w3-button w3-left" disasbled={true}>
                                <h4><strong>Batch #1</strong></h4>
                            </span>
                        </div>
                        <div className="w3-col s4 w3-container ">
                            <button className="w3-button w3-right">
                                <h4>
                                    <i className="fa fa-ellipsis-h"></i>&nbsp;Edit
                                </h4>
                            </button>
                        </div>
                    </div>
                    ...
                    */}
                    ...
                    <ul className="w3-ul">
                        ...
                        <li className="w3-cell-row w3-border-bottom" style={{padding:"0px",}}>
                            <div className="w3-white w3-cell w3-container  w3-round-xlarge">
